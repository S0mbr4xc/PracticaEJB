...
a persistence unit "clientPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "client/pom.xml":
...
artifact ("client.war") is already built. You can build
